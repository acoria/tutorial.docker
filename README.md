...
Run a container with **docker run -p 5005:5000 <image_name>**  
 ...
 Attention: When a server logs that it runs on a certain port, it might be misleading, such as the port 5000 here which is mapped to 5005.
